...
import { MdSyncLock, MdWorkspacePremium } from "react-icons/md";
        ...
        <Reveal>
          <div className="flex flex-col justify-center mx-auto group">
            ...
            <p className="mb-8 mt-4 text-center text-md font-dmsans text-[#fff9] font-normal max-w-xl mx-auto">
              ...
              soluções são desenhadas para oferecer{" "}
              <span className="text-red-500">o melhor serviço</span> com{" "}
              <span className="text-red-500">total confiabilidade.</span>
            </p>
          </div>
        </Reveal>
        ...
        <Reveal>
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <div className="bg-[#0A0A0D] border border-solid border-[#111] p-8 rounded-xl flex flex-col items-start w-full max-w-md h-64 transition duration-300 hover:scale-105">
              ...
              <h3 className="text-2xl font-dmsans font-semibold text-white mb-4">
                Proteção Completa
              </h3>
              <p className="font-dmsans font-normal text-[#fff9]">
                Anonimato é nossa prioridade. Compre tranquilo, sabendo que seus
            ...
            <div className="bg-[#0A0A0D] border border-solid border-[#111] p-8 rounded-xl flex flex-col items-start w-full max-w-md h-64 transition duration-300 hover:scale-105">
              ...
              <p className="font-dmsans font-normal text-[#fff9]">
                Serviço rápido e eficiente. Ao comprar qualquer conta ela é
                entregue no mesmo momento.
              </p>
            </div>
            ...
            <div className="bg-[#0A0A0D] border border-solid border-[#111] p-8 rounded-xl flex flex-col items-start w-full max-w-md h-64 transition duration-300 hover:scale-105">
              ...
              <p className="font-dmsans font-normal text-[#fff9]">
                A cada transação nova é feito uma verificação minuciosa para sua
                segurança.
              </p>
            </div>
          </div>
