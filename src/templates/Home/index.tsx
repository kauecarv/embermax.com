...
import { ContactUsTemplate } from "@/templates/Home/ContactUs";
import { FeaturesTemplate } from "@/templates/Home/Features";
import { ProductTemplate } from "@/templates/Home/Product";
import { ReviewsTemplate } from "@/templates/Home/Reviews";
          ...
          <div className="relative z-10">
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl items-center justify-center text-center lg:py-16 lg:px-12">
              ...
              <p className="mb-8 text-md font-dmsans text-[#fff9] font-normal max-w-xl mx-auto">
                Desbloqueie o seu potencial de jogo com nossas contas de
                Valorant, garantindo a sua segurança e qualidade em cada
                transação.
              </p>
