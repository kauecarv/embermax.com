...
import { FaFire, FaHeadphones, FaRegCalendar } from "react-icons/fa6";
import { LuMoveLeft } from "react-icons/lu";
import { TbFlagCancel, TbMoneybag, TbShield } from "react-icons/tb";
          ...
          <div className="flex flex-col bg-neutral-950 rounded-xl w-full px-6">
            <div className=" flex flex-wrap justify-between px-6 py-8">
              <div className="flex flex-col">
                <Link
                  href="/₢ategorias"
                  className="text-[#fff9] transition duration-300 hover:text-white text-sm font-dmsans font-normal px-2 mb-2 inline-flex gap-2 items-center"
                >
                  <LuMoveLeft /> Voltar a Categorias
                </Link>
                ...
                <h1 className="text-white text-3xl font-dmsans font-semibold">
                  <span className="text-red-500 text-3xl inline-flex items-center font-dmsans gap-2 font-semibold">
                    Pedido #eI6IPN{" "}
                    <span className="text-sm text-[#fff9] font-dmsans font-normal mt-2">
                      Este pedido custa R$500,00
                    </span>
                  </span>{" "}
                </h1>
                ...
                <div className="flex flex-wrap lg:py-4 lg:px-12 justify-between w-full">
                  <div className="flex flex-col w-full">
                    ...
                    <div className="flex flex-col py-2 lg:px-6">
                      ...
                      <span className="text-[#fff9] font-dmsans font-normal text-sm">
                        Antes de prosseguir, certifique-se que você leu
                        atentamente nossos{" "}
