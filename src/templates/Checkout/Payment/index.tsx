          ...
          <div className="flex flex-col bg-neutral-950 rounded-xl w-full max-w-5xl mx-auto px-6 py-6">
            ...
            <div className=" flex flex-wrap justify-center items-center px-6 py-8">
              <div className="flex flex-col text-center">
                ...
                <p className="py-2 text-[#fff9] font-dmsans font-normal inline-flex items-center gap-2 text-sm">
                  <BsNewspaper /> Está quase lá... Insira seus dados
                  corretamente.
                </p>
              </div>
            </div>
              ...
              <div>
                <div className="sm:flex rounded-lg shadow-sm">
                  ...
                  <span className="py-3 px-4 inline-flex items-center min-w-fit w-full border border-gray-200 bg-gray-50 text-sm text-gray-500 -mt-px -ms-px first:rounded-t-lg last:rounded-b-lg sm:w-auto sm:first:rounded-s-lg sm:mt-0 sm:first:ms-0 sm:first:rounded-se-none sm:last:rounded-es-none sm:last:rounded-e-lg dark:bg-neutral-700 dark:border-neutral-700 dark:text-neutral-400">
                    <svg
                      className="hidden sm:block size-4 text-gray-400 dark:text-neutral-500"
                    ...
                    <svg
                      className="sm:hidden mx-auto size-4 text-gray-400 dark:text-neutral-500"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
            ...
            <div className="flex flex-col text-center mx-auto py-6 px-6">
              ...
              <p className="text-sm text-[#fff9] font-dmsans font-normal">
                Para finalizar sua compra, selecione seu método de pagamento.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-2 items-center">
              <label
                ...
                className="flex p-3 w-full justify-between items-center rounded-lg text-sm bg-neutral-900  text-red-400 transition duration-300 hover:scale-95"
              >
                <span className="text-sm font-dmsans font-normal text-[#fff9] inline-flex items-center gap-2">
                  <img src="https://d1muf25xaso8hp.cloudfront.net/https%3A%2F%2F5dc23420da8ac043a4031153c442acf4.cdn.bubble.io%2Ff1698469658781x945862073620170100%2Fpix.png?w=96&h=48&auto=compress&dpr=1&fit=max"></img>
                </span>
                <span className="bg-neutral-950 py-2 px-2 rounded-xl inline-flex items-center gap-2">
                  <BiSolidSelectMultiple className="text-emerald-500" />
                </span>
              </label>

              <label
                htmlFor="hs-radio-on-right"
                className="flex p-3 w-full justify-between items-center rounded-lg text-sm bg-neutral-900  text-red-400 opacity-50"
              >
                <span className="text-sm text-[#fff9] font-dmsans font-normal inline-flex gap-2 items-center">
                  <img
                    src="https://d1muf25xaso8hp.cloudfront.net/https%3A%2F%2F5dc23420da8ac043a4031153c442acf4.cdn.bubble.io%2Ff1712686712660x715767103509195300%2F2695969.png?w=96&h=48&auto=compress&dpr=1&fit=max"
            ...
            <div className="flex flex-col w-full bg-neutral-900 mt-12 rounded-xl py-6 px-6">
              <h1 className="font-poppins font-bold text-white text-3xl px-2">
                Resumo da Compra
              </h1>
              ...
              <div className="flex flex-col px-2 py-6">
                <h1 className="text-3xl text-white font-bold font-poppins px-2">
                  R$ 399,99
                </h1>
                <div className="w-full py-2 space-y-3">
                  <div className="relative">
                    <input
                      type="password"
                      className="peer py-3 px-4 ps-11 block w-full bg-neutral-950 rounded-md"
            ...
            <div className="flex fle-col w-full justify-between gap-4 py-6 px-4">
              <div className="flex gap-2 items-center">
                ...
                <label
                  ...
                  className="text-sm text-[#fff9] font-dmsans font-normal"
                >
                  Li e estou de acordo com os{" "}
                  <Link href="tos" className="text-red-500">
                    Termos de Serviço.
                  </Link>
                </label>
              </div>
