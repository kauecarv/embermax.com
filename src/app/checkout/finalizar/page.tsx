          ...
          <div className="flex flex-col bg-neutral-950 rounded-xl w-full max-w-5xl mx-auto px-6 py-6">
            <div className="flex items-center gap-x-1 py-6">
              ...
              <div>
                <div className="w-10 text-end">
                  <span className="text-sm text-red-500 font-dmsans font-medium">50%</span>
                </div>
              </div>
            </div>
            <div className=" flex flex-wrap justify-center items-center px-6 py-8">
              <div className="flex flex-col text-center">
                ...
                <p className="py-2 text-[#fff9] font-dmsans font-normal inline-flex items-center gap-2 text-sm">
                  <BiCheck /> Confirme os produtos que você está comprando abaixo:
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              <div className="flex w-full py-6 px-6 bg-neutral-900 rounded-xl items-center">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex flex-col items-start justify-center">
                    <h1 className="text-white font-dmsans font-medium text-lg inline-flex items-center gap-2 py-2"><TbShield className="text-red-500" /> Garantia Estendida</h1>
                    <p className="text-sm text-[#fff9] font-dmsans font-normal">
                      Você pode pagar um adicional e estender sua garantia caso deseja uma segurança extra para sua conta.
                    </p>


                    <form className="w-full py-2 items-center">
                      <select id="countries" className="bg-neutral-950 text-white text-sm rounded-lg block w-full p-2.5">
                        <option selected>Garantia de 1 mês</option>
                        <option value="2month">Garantia de 2 meses - R$15,99 </option>
                        <option value="2month">Garantia de 3 meses - R$24,99 </option>
                        <option value="2month">Garantia de 6 meses - R$39,99 </option>
              ...
              <div className="flex w-full py-6 px-6 bg-neutral-900 rounded-xl items-center">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex flex-col items-start justify-center mb-4">
                    <h1 className="text-white font-dmsans font-medium text-lg inline-flex items-center gap-2 py-2"><FaBolt className="text-red-500" /> Entrega Imediata</h1>
                    <p className="text-sm text-[#fff9] font-dmsans font-normal">
                      Está com pressa para receber seu produto? Você pode pagar um adicional para ter uma entrega priorizada.
                    </p>

                    <p className="inline-flex gap-2 items-center font-dmsans text-red-500 font-normal text-sm py-2"> Este produto já é prioridade de entrega imediata.</p>
            ...
            <div className="flex justify-between items-center px-6 py-6">
              <h1 className="text-white font-poppins font-bold text-xl">R$399,99</h1>
